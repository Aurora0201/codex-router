...
lines.on("line", (line) => {
  ...
  if (message.method === "model/list") result = { data: [{ id: "gpt-fake-default", displayName: "Fake Default", isDefault: true }, { id: "gpt-fake-mini", displayName: "Fake Mini", isDefault: false }], nextCursor: null };
